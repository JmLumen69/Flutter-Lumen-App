...
class _TodoScreenState extends State<TodoScreen> {
  ...
  static const _surface = Color(0xFF1A1230);
  ...
  void _confirmClearTrash(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('Permanently delete all tasks in the trash?', style: TextStyle(color: Colors.white.withValues(alpha: 0.7))),
        actions: [
          TextButton(
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: isSelected ? [BoxShadow(color: _accent.withValues(alpha: 0.4), blurRadius: 8, offset: const Offset(0, 3))] : [],
                ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            const Text('My Tasks', style: TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold, letterSpacing: -0.5)),
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: TextButton.icon(
                        ...
                        icon: const Icon(Icons.delete_sweep_rounded, color: Color(0xFFEF5350)),
                        label: const Text('Clear All', style: TextStyle(color: Color(0xFFEF5350))),
                      ),
                    ),
                  ),
                          ...
                          itemBuilder: (context, i) {
                            ...
                            if (_filter == 'Active') {
                              backgroundWidget = Container(
                                ...
                                decoration: BoxDecoration(color: const Color(0xFF66BB6A), borderRadius: BorderRadius.circular(16)),
                              ...
                              secondaryBackgroundWidget = Container(
                                margin: const EdgeInsets.only(bottom: 12),
                                decoration: BoxDecoration(color: const Color(0xFFEF5350), borderRadius: BorderRadius.circular(16)),
                                alignment: Alignment.centerRight,
                              ...
                              backgroundWidget = Container(
                                margin: const EdgeInsets.only(bottom: 12),
                                decoration: BoxDecoration(color: const Color(0xFFFFCA28), borderRadius: BorderRadius.circular(16)),
                                alignment: Alignment.centerLeft,
                                padding: const EdgeInsets.only(left: 24),
                            ...
                            return Dismissible(
                              ...
                              child: TodoTile(todo: todo, onEdit: _filter == 'Deleted' ? null : () => _showAddTodoDialog(todo)),
                            );
                          },
                        ),
                ),
      ...
      floatingActionButton: _filter == 'Deleted'
          ...
          : Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: _accent.withValues(alpha: 0.5), blurRadius: 16, offset: const Offset(0, 4))],
              ),
...
class _TodoDialog extends StatefulWidget {
  const _TodoDialog({this.existingTodo, required this.onSave});
  ...
  Future<void> _pickDate() async {
    final picked = await showDatePicker(
      ...
      builder: (context, child) => Theme(
        data: ThemeData.dark().copyWith(colorScheme: const ColorScheme.dark(primary: _accent, onPrimary: Color(0xFF0F0A1E), surface: _surface)),
        child: child!,
      ),
    );
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Task Title', labelStyle: const TextStyle(color: _muted),
              ...
              TextField(
                ...
                maxLines: 3,
                decoration: InputDecoration(
                  labelText: 'Description (optional)', labelStyle: const TextStyle(color: _muted),
                  filled: true, fillColor: Colors.white.withValues(alpha: 0.05),
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: BorderSide.none),
                ),
              ),
                ...
                children: [
                  Expanded(
                    child: DropdownButtonFormField<String>(
                      ...
                      style: const TextStyle(color: Colors.white, fontSize: 14),
                      decoration: InputDecoration(
                        labelText: 'Priority', labelStyle: const TextStyle(color: _muted),
                        filled: true, fillColor: Colors.white.withValues(alpha: 0.05),
                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: BorderSide.none),
                      ),
                      items: const [
                  ...
                  Expanded(
                    child: DropdownButtonFormField<String>(
                      ...
                      style: const TextStyle(color: Colors.white, fontSize: 14),
                      decoration: InputDecoration(
                        labelText: 'Category', labelStyle: const TextStyle(color: _muted),
                        filled: true, fillColor: Colors.white.withValues(alpha: 0.05),
                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: BorderSide.none),
                      ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(color: _dueDate == null ? _muted : Colors.white, fontSize: 14),
                        ),
                      ),
                      if (_dueDate != null)
                        InkWell(onTap: () => setState(() => _dueDate = null), child: const Icon(Icons.close_rounded, size: 18, color: _muted)),
                    ],
                  ),
                ),
              ),
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _accent, foregroundColor: const Color(0xFF0F0A1E),
