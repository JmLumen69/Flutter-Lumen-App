...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final navyColor = isDark ? const Color(0xFF0F0A1E) : const Color(0xFFF3F0FF);
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        decoration: BoxDecoration(
          border: Border(
            top: BorderSide(color: _accent.withValues(alpha: 0.12), width: 1),
          ),
        ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Switch(
                                    ...
                                    inactiveThumbColor: const Color(0xFF9D8EC4),
                                    onChanged: (val) {
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.face_rounded, color: Color(0xFF8B5CF6), size: 22),
          ),
